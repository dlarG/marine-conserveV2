...
const DiveAgainstDebris = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Dive Against Debris | GREEN Inc. Volunteer";
  }, []);

  const programData = {
    title: "Dive Against Debris",
    tagline:
      "Remove ghost gear and plastic pollution, documenting every piece to help drive global policy changes for cleaner oceans.",
    heroImage:
      "https://res.cloudinary.com/dfsxmtyxk/image/upload/v1777343078/P8190137_zohnsu.jpg",
    fullDescription: [
      "Marine debris is one of the most pressing environmental challenges of our time. Every year, millions of tons of plastic enter our oceans, entangling marine life and degrading critical habitats. In Sogod Bay, the fight against debris is personal—our reefs and marine species depend on clean waters to thrive.",
      "The Dive Against Debris program puts you on the front lines of this battle. You'll not only remove harmful waste from our marine environment but also contribute to a global database that informs policy decisions worldwide.",
      "This isn't just a clean-up—it's a data-driven conservation initiative. Every piece of debris you document helps build the case for stronger environmental protections.",
    ],
    activities: [
      "Conduct underwater debris removal surveys",
      "Document and categorize collected waste items",
      "Remove ghost fishing gear and abandoned nets",
      "Participate in beach and mangrove clean-ups",
      "Learn about the impact of marine pollution",
      "Contribute data to Project AWARE's global database",
      "Educate local communities about waste management",
      "Help develop strategies to reduce debris sources",
    ],
    duration: "Flexible (1–24+ weeks)",
    bestFor: "Divers committed to ocean conservation",
    ...
    inclusions: [
      "Participation in Dive Against Debris operations",
      "Training in debris survey and documentation methods",
      "Regular underwater and coastal clean-up dives",
      ...
      "Tuition and lectures on marine pollution",
    ...
    outcomes: [
      "Hands-on experience in marine debris management",
      "Understanding of global debris data collection standards",
      "Skills in underwater survey techniques",
      "Knowledge of marine pollution impacts and solutions",
