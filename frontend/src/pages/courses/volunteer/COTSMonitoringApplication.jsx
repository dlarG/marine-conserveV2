...
import { X, Check, Star, Fish, ArrowLeft, Shield } from "lucide-react";

const COTSMonitoringApplication = () => {
  ...
  const programs = [
    {
      ...
      inclusions: [
        "Basic COTS identification training",
        "Safe handling & removal certification",
  ...
  const handleSubmit = async (e) => {
    ...
    submitFormData.append("program_type", "COTS Monitoring");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dfsxmtyxk/image/upload/v1777343004/255053295_1323088658146866_9006587557721285913_n_qfsh6m.jpg')",
        }}
      >
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-xl mb-6 text-white/90">
              Track and manage outbreaks of coral-eating Crown-of-Thorns
              starfish to protect our local reefs.
            </p>
            <div className="flex gap-6">
              <div className="flex items-center gap-2">
                <Shield className="w-5 h-5 text-emerald-300" />
                <span className="text-white/80">Reef Protection</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="bg-gradient-to-r from-teal-600 to-emerald-600 text-white p-6 rounded-t-2xl">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-teal-100 mt-1">COTS Monitoring</p>
                    <p className="text-teal-50 text-sm mt-2">
                      Join our reef protection mission in Sogod Bay.
                    </p>
                  </div>
                  <button
                    onClick={() => setIsModalOpen(false)}
...
export default COTSMonitoringApplication;
