...
const CoralRestorationApplication = () => {
  ...
  const programs = [
    {
      ...
      inclusions: [
        "Basic coral restoration training",
  ...
  const handleSubmit = async (e) => {
    ...
    submitFormData.append("program_type", "Coral Restoration");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dfsxmtyxk/image/upload/v1777343136/555705217_10238078344967574_7898261656592206056_n_mjjsbg.jpg')",
        }}
      >
        {/* Overlay */}
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center">
          ...
          >
            ...
            <span className="text-sm font-medium">Back to Volunteer</span>
          </button>
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-xl mb-6 text-white/90">
              Join our marine conservation mission in Sogod Bay. Help restore
              coral reefs and protect marine biodiversity through hands-on
              volunteer work.
            </p>
            <div className="flex gap-6">
              <div className="flex items-center gap-2">
                <Waves className="w-5 h-5 text-emerald-300" />
                <span className="text-white/80">24 Weeks Program</span>
              </div>
              <div className="flex items-center gap-2">
                <Fish className="w-5 h-5 text-emerald-300" />
                <span className="text-white/80">Hands-on Training</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="bg-gradient-to-r from-teal-600 to-emerald-600 text-white p-6 rounded-t-2xl">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-teal-100 mt-1">Coral Restoration</p>
...
export default CoralRestorationApplication;
