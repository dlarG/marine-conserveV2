...
import { X, Check, Star, Fish, ArrowLeft, Clipboard } from "lucide-react";

const DataCollectionApplication = () => {
  ...
  const programs = [
    {
      ...
      inclusions: [
        "Basic survey methodology training",
        "Fish & substrate identification",
  ...
  const handleSubmit = async (e) => {
    ...
    submitFormData.append("program_type", "Scientific Data Collection");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dfsxmtyxk/image/upload/v1777342895/DSCF5597_lmehg1.jpg')",
        }}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-teal-900/80 to-transparent" />
        <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center">
          <button
            onClick={() => navigate("/volunteer/scientific-data-collection")}
          ...
          <div className="max-w-2xl">
            <h1 className="text-5xl font-bold mb-4 text-white">
              Scientific Data Collection Program
            </h1>
            <p className="text-xl mb-6 text-white/90">
              Master ecological data gathering and contribute to long-term
              datasets that help us understand sanctuary health.
            </p>
            <div className="flex gap-6">
              <div className="flex items-center gap-2">
                <Clipboard className="w-5 h-5 text-emerald-300" />
                <span className="text-white/80">Citizen Science</span>
              </div>
              <div className="flex items-center gap-2">
                <Fish className="w-5 h-5 text-emerald-300" />
                <span className="text-white/80">Research Methods</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-15 container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-base text-gray-600">
            Select the program duration that fits your research goals
          </p>
        </div>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-teal-50 text-sm mt-2">
                      Join our research mission in Sogod Bay.
                    </p>
                  </div>
                  <button
                    onClick={() => setIsModalOpen(false)}
...
export default DataCollectionApplication;
