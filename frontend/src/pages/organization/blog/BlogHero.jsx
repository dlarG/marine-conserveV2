    ...
    <header className="relative w-full h-[50vh] min-h-[260px] overflow-hidden bg-gray-900">
      ...
      <div
        ...
        style={{
          ...
          animation: "blogHeroShimmer 1.2s linear infinite",
        }}
        aria-hidden="true"
      />
...
const BlogHero = ({
  ...
  backgroundVideoUrl = "https://res.cloudinary.com/dfsxmtyxk/video/upload/f_auto,q_auto:good,w_1280,c_limit/v1774838240/17454110-uhd_3840_2160_25fps_cidtyu.mp4",
  maxWaitMs = 1200,
  onReady,
}) => {
  ...
  if (!shouldShowContent) return <BlogHeroSkeleton />;
