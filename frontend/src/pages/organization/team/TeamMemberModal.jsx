...
const TeamMemberModal = ({ isOpen, onClose, member }) => {
  ...
  const memberStories = {
    "Jerome Jack Napala": {
      story: [
        "From the Office Work to the Coral Reefs: The Jerome 'Eyom' Napala Story",
        "Growing up in the coastal communities of Southern Leyte, Jerome Jack Napala—who prefers to be called by his nickname, Eyom—developed an intimate connection with the ocean from an early age. As a child, Eyom spent countless hours exploring the vibrant coral reefs that would later become his life's work. The underwater world wasn't just a playground; it was his classroom, teacher, and eventually, his calling.",
        "However, his professional journey took a scenic route. Eyom initially earned a B.S. in Commerce Major in Business Administration and dedicated nearly two decades of his career to serving as vital administrative personnel at Southern Leyte State University (SLSU).",
        "His life took a pivotal turn when he landed a Marine Science Scholarship with Coral Cay Conservation. It was there that Eyom first learned to breathe underwater, earning his PADI Open Water and Advanced Open Water Diver certification. This life-altering experience became the major catalyst for his powerful 'second act'—he went back to school to complete a second degree in Marine Biology.",
        "Right after completing his marine biology course, Eyom's dedication earned him a promotion from administration straight into the university's Research Department. He didn't stop there, either—his passion drove him to master the waves, eventually becoming a certified PADI Open Water Scuba Instructor.",
        "The Turning Point: Bridging Science and Field Reality",
        "A foundational chapter in his conservation journey took place way back in 2012, when Eyom served as a Project Technical Staff member for a government-funded national coral restoration program. It was during this pivotal time that he closely observed various methodologies in asexual coral restoration.",
        "Through hands-on field trials, Eyom reached a critical realization that would define his entire philosophy: not all restoration methods work in every location. He saw firsthand that what thrives in one part of the coast might fail in another due to unique currents, depth, and environmental factors. This invaluable experience taught him the necessity of site-specific testing—meticulously deploying different methods across diverse sites, monitoring the results, and picking only what is proven to suit that specific ecosystem before scaling up.",
        "Armed with this scientific insight and a heartbreaking view of the reefs showing severe signs of bleaching, damage from destructive fishing, crown of thorns outbreaks, and climate change, Eyom decided to take action into his own hands.",
        "Building a Movement from the Sand Up",
        "With little more than determination, plastic bottles, and ropes, Eyom established his first coral nursery. Applying his site-testing philosophy, what started as a small, calculated experiment has grown into one of the most successful community-based coral restoration programs in the area. His innovative techniques, combining traditional knowledge with robust scientific methodology, have restored hectares of damaged reef systems.",
        "Today, as the CEO of GREEN, Inc., Eyom possesses a rare and highly valuable balance in conservation. He seamlessly bridges the gap between administrative acumen, university research, elite scuba instruction, and decades of adaptive field experience. While leading a team of dedicated marine conservationists and empowering local communities to become lifelong stewards of their marine resources, Eyom still dives regularly in the waters he has worked so hard to protect—proving that with enough passion, you can rewrite your own story and rewrite the future of our reefs.",
      ],
    },
    "Christian Polo": {
      story: [
