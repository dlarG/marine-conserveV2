    ...
    <header className="relative w-full min-h-[60vh] md:h-[50vh] overflow-hidden bg-gray-900 pt-[100px] md:pt-0">
      ...
      <div
        ...
        style={{
          ...
          animation: "teamHeroShimmer 1.2s linear infinite",
        }}
        aria-hidden="true"
      />
...
const TeamHero = ({
  ...
  backgroundVideoUrl = "https://res.cloudinary.com/dfsxmtyxk/video/upload/f_auto,q_auto:good,w_1280,c_limit/v1774837305/14920043-uhd_3840_2160_25fps_sob7sx.mp4",
  maxWaitMs = 1500,
  onReady,
}) => {
